...
\imvNLA{} severity units: all six stealth cases missed by $O\cup C$.
...
\\
post-hoc LP upper bound & 44.4 & 9.0 & 33.3\%\\
\bottomrule
\end{tabular}
...
objective that lacks calibrated risk or benefit estimates. The post-hoc LP row reuses realized mock benefits and is therefore an optimistic
upper bound, not a deployable estimate. These results support neither acceptance
nor rejection of the preregistered real-model hypotheses.
