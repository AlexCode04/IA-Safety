...
probe. In this synthetic demonstration, observable monitoring catches
\phrObservableCount{} harmful attempts and CoT catches \phrCoTCount{}, while
the deliberately separable mock probe and NLA channels catch
\phrProbeCount{} and \phrNLACount{}, respectively. A severity-only routing
heuristic can nevertheless perform worse than action-only monitoring by
spending scarce budget on benign high-severity cases. The result illustrates
why incident-response evaluations must jointly report detection, intervention
timing, false disruption, and resource use.
\end{abstract}
