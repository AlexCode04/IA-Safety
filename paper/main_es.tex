...
\caption{Vista estática para publicación del dashboard operacional, regenerada
desde el mismo resumen canónico que consumen ambos documentos. La insignia roja
de procedencia impide confundir la demostración sintética con evidencia de
modelos reales; la aplicación interactiva agrega filtros e inspección por caso.}
\label{fig:dashboard}
\end{figure*}
