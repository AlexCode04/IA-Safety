...
demostración sintética, Observable detecta \phrObservableCount{} intentos
dañinos y CoT detecta \phrCoTCount{}, mientras los canales mock Probe y NLA,
separables por construcción, detectan \phrProbeCount{} y \phrNLACount{},
respectivamente. Sin embargo, un enrutamiento basado solo en severidad puede
rendir peor que action-only al gastar presupuesto en casos benignos de alta
severidad.
\end{abstract}
