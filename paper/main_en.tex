...
\begin{figure*}[t]
\centering
\includegraphics[width=0.97\textwidth]{figures/dashboard_summary.pdf}
\caption{Static publication view of the operator dashboard, regenerated from
the same canonical summary used by both manuscripts. The red provenance badge
prevents the synthetic demonstration from being mistaken for real-model
evidence; the interactive application adds filters and per-case drill-down.}
\label{fig:dashboard}
\end{figure*}
